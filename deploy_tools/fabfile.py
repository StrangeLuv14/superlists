...
REPO_URL = 'https://github.com/StrangeLuv14/superlists.git'
...
def _get_latest_source(source_folder):
    #check whether .git folder has been cloned to server
    if exists(source_folder + '/.git'):
        #pull depo from online code depo
        run('cd %s && git fetch' % (source_folder,))
    else:
        #if depo don't exist clone from online
